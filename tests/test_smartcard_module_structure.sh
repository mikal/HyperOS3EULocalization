...
assert_contains "$BUILD_SCRIPT" 'for component in MINextpay MITSMClient UPTsmService PaymentService MIUISuperMarket; do'
...
assert_contains "$ROOT_DIR/customize.sh" 'AppStore'
assert_contains "$ROOT_DIR/lang/zh_CN.ini" 'LANG_TEXT_READING_CONFIG_APPSTORE="应用商店"'
assert_contains "$ROOT_DIR/lang/en_US.ini" 'LANG_TEXT_READING_CONFIG_APPSTORE="Xiaomi App Store"'
